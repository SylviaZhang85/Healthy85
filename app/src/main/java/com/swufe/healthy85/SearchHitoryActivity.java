...
public class SearchHitoryActivity extends ListActivity implements Runnable, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        key =getIntent().getStringExtra("EXTRA_MESSAGE");
        ...
        handler = new Handler() {
            ...
            public void handleMessage(@NonNull Message msg) {
                if (msg.what == 7) {
                    ...
                    listItemAdapter = new SimpleAdapter(SearchHitoryActivity.this, listItems,
                            R.layout.list_item,
